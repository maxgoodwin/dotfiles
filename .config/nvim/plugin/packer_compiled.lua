...
_G.packer_plugins = {
  ...
  colorschemes = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/colorschemes",
  ...
  ["doom-one.vim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/doom-one.vim",
    url = "https://github.com/romgrk/doom-one.vim"
  },
  fd = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/fd",
  ...
  ["lsp-colors.nvim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/lsp-colors.nvim",
  ...
  nerdtree = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/nerdtree",
    url = "https://github.com/preservim/nerdtree"
  },
  ["nerdtree-git-plugin"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/nerdtree-git-plugin",
  ...
  ripgrep = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/ripgrep",
  ...
  ["vim-devicons"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/vim-devicons",
  ...
  ["vim-nerdtree-syntax-highlight"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/vim-nerdtree-syntax-highlight",
    url = "https://github.com/tiagofumo/vim-nerdtree-syntax-highlight"
  },
  vimwiki = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/vimwiki",
